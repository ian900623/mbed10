...
#define MBED_CONF_APP_WIFI_PASSWORD                                             "67891000"                                                                                       // set by application
#define MBED_CONF_APP_WIFI_SSID                                                 "elephant"                                                                                       // set by application
...
#define MBED_CONF_BLUENRG_MS_SPI_IRQ                                            PE_6                                                                                             // set by library:bluenrg_ms[B_L4S5I_IOT01A]
#define MBED_CONF_BLUENRG_MS_SPI_MISO                                           PC_11                                                                                            // set by library:bluenrg_ms[B_L4S5I_IOT01A]
#define MBED_CONF_BLUENRG_MS_SPI_MOSI                                           PC_12                                                                                            // set by library:bluenrg_ms[B_L4S5I_IOT01A]
#define MBED_CONF_BLUENRG_MS_SPI_NCS                                            PD_13                                                                                            // set by library:bluenrg_ms[B_L4S5I_IOT01A]
#define MBED_CONF_BLUENRG_MS_SPI_RESET                                          PA_8                                                                                             // set by library:bluenrg_ms[B_L4S5I_IOT01A]
#define MBED_CONF_BLUENRG_MS_SPI_SCK                                            PC_10                                                                                            // set by library:bluenrg_ms[B_L4S5I_IOT01A]
